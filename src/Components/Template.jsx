  ...
  return (
    ...
    <div className="flex w-11/12 max-w-[1160px] py-12 mx-auto gap-y-0 gap-x-12 justify-between text-richblack-100  ">
      <div className="w-11/12 max-w-[450px] flex flex-col">
        ...
        <button className="w-full flex rounded-md items-center justify-center border border-richblack-700 font-medium text-richblack-100 px-[12px] py-[8px] gap-x-2 mt-6">
          <FcGoogle />
      ...
      <div className="relative w-11/12 max-w-[450px]">
        <img src={frame} alt="
        pattern" width={558} height={504} loading="lazy" />
        <img
          src={props.image}
          alt="Students"
          width={558}
